...
namespace PopupCash.Models.Commands.Impl
{
    ...
    /// extension.
    /// </summary>
    public abstract class TrayIconCommandBase<T> : MarkupExtension, ICommand
        where T : class, ICommand, new()
    {
        ...
        {
            if (command is null) command = new T();
            return command;
        }
        ...
        protected Window? GetTaskbarWindow(object commandParameter)
        {
            ...
            if (commandParameter is not TaskbarIcon taskbarIcon) return null;
        ...
        {
            //get parent item
            if (GetParentObject(child) is not DependencyObject parentObject) return null;
        ...
        public static DependencyObject? GetParentObject(DependencyObject child)
        {
            ...
            if (child is ContentElement contentElement)
            {
                ...
                if (contentElement is FrameworkContentElement element)
